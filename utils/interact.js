...
const contract = require("../artifacts/contracts/Adessi.sol/Adessi.json");
const contractAddress = "0x0568CB91064a34B28750920470d1dee3c9a94936";
...
export const mintNFT = async (mintAmount) => {
  ...
  const transactionParameters = {
    ...
    gasLimit: "0",
    data: nftContract.methods.mintAdessi(mintAmount).encodeABI(), //make call to NFT smart contract
  };
